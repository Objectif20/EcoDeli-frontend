...
export class DeliveriesAPI {
  ...
  static async askToNegotiate(shipment_id: string): Promise<any> {
    try {
      const response = await axiosInstance.post(
        `/client/shipments/${shipment_id}/askNegociation`
      );
      return response.data;
    } catch (error) {
  ...
  static async getMyCurrentShipments(): Promise<Delivery[]> {
    try {
      const response = await axiosInstance.get<Delivery[]>(
        "/client/shipments/myCurrentShipmentsForNegotiation"
      );
      return response.data;
    } catch (error) {
  ...
  static async createPartialDelivery(
    ...
    try {
      const response = await axiosInstance.post(
        `/client/shipments/${shipment_id}/bookPartial`,
        data
      );
      return response.data;
    } catch (error) {
  ...
  static async getMyOngoingDeliveriesAsDeliveryman(): Promise<
    DeliveryOnGoing[]
  > {
    try {
      const response = await axiosInstance.get<DeliveryOnGoing[]>(
        "/client/shipments/onGoingDeliveries"
      );
      return response.data;
    } catch (error) {
  ...
  static async getMyDeliveryHistoryAsDeliveryman(
    pageIndex: number,
    pageSize: number
    ...
    try {
      const response = await axiosInstance.get<{
        ...
        totalRows: number;
      }>("/client/shipments/delivery/myHistory", {
        params: {
          page: pageIndex,
          limit: pageSize,
        },
  ...
  static async getMyReviewsAsDeliveryman(
    pageIndex: number,
    pageSize: number
  ): Promise<{ data: ReviewAsDeliveryPerson[]; totalRows: number }> {
    try {
      const response = await axiosInstance.get<{
        data: ReviewAsDeliveryPerson[];
        totalRows: number;
      }>("/client/shipments/delivery/reviews", {
        params: {
          page: pageIndex,
          limit: pageSize,
        },
  ...
  static async replyToReview(review_id: string, content: string): Promise<any> {
    try {
      const id = review_id;
      const response = await axiosInstance.post(
        `/client/shipments/delivery/reviews/${id}/reply`,
        { content }
      );
      return response.data;
    } catch (error) {
  ...
  static async getMyReviewsAsClient(
    pageIndex: number,
    pageSize: number
    ...
    try {
      const response = await axiosInstance.get<{
        data: ReviewAsClient[];
        totalRows: number;
      }>("/client/shipments/delivery/myReviews", {
        params: {
          page: pageIndex,
          limit: pageSize,
        },
  ...
  static async getMyDeliveriesLocation(): Promise<DeliveriesLocation[]> {
    try {
      const response = await axiosInstance.get<DeliveriesLocation[]>(
        "/client/shipments/delivery/myLocation"
      );
      return response.data;
    } catch (error) {
  ...
  static async getCurrentDeliveriesAsClient(): Promise<
    CurrentDeliveryAsClient[]
  > {
    try {
      const response = await axiosInstance.get<CurrentDeliveryAsClient[]>(
        "/client/shipments/delivery/current"
      );
      return response.data;
    } catch (error) {
  ...
  static async takeDeliveryPackage(
    delivery_id: string,
    secretCode: string
  ): Promise<any> {
    try {
      const response = await axiosInstance.post(
        `/client/shipments/delivery/${delivery_id}/taken`,
        { secretCode }
      );
      return response.data;
    } catch (error) {
  ...
  static async finishedDelivery(delivery_id: string): Promise<any> {
    try {
      const response = await axiosInstance.post(
        `/client/shipments/delivery/${delivery_id}/finish`
      );
      return response.data;
    } catch (error) {
      console.error("Error taking delivery package:", error);
  ...
  static async validateDelivery(delivery_id: string): Promise<any> {
    try {
      const response = await axiosInstance.post(
        `/client/shipments/delivery/${delivery_id}/validate`
      );
      return response.data;
    } catch (error) {
      console.error("Error taking delivery package:", error);
  ...
  static async validateDeliveryWithCode(
    delivery_id: string,
    secretCode: string
  ): Promise<any> {
    try {
      const response = await axiosInstance.post(
        `/client/shipments/delivery/${delivery_id}/validateWithCode`,
        { secretCode }
      );
      return response.data;
    } catch (error) {
  ...
  static async getSubscriptionStat(): Promise<SubscriptionForClient> {
    try {
      const response = await axiosInstance.get<SubscriptionForClient>(
        "/client/shipments/subscriptionStat"
      );
      return response.data;
    } catch (error) {
  ...
  static async getShipmentDetailsByIdOffice(
    shipment_id: string
  ): Promise<ShipmentsDetailsOffice> {
    try {
      const response = await axiosInstance.get<ShipmentsDetailsOffice>(
        `/client/shipments/office/${shipment_id}`
      );
      return response.data;
    } catch (error) {
      console.error("Error fetching shipment details:", error);
  ...
  static async getMyCurrentShipmentsOffice(): Promise<ShipmentListItem[]> {
    try {
      const response = await axiosInstance.get<ShipmentListItem[]>(
        "/client/shipments/myCurrentShipments"
      );
      return response.data;
    } catch (error) {
      console.error("Error fetching current shipments:", error);
  ...
  static async getMyShipmentsHistoryOffice(
    pageIndex: number,
    pageSize: number
  ): Promise<{ data: ShipmentHistoryRequest[]; totalRows: number }> {
    try {
      const response = await axiosInstance.get<{
        data: ShipmentHistoryRequest[];
        totalRows: number;
      }>("/client/shipments/myShipmentsHistory", {
        params: {
          page: pageIndex,
          limit: pageSize,
        },
  ...
  static async getMyDeliveriesHistoryAsClient(
    pageIndex: number,
    pageSize: number
  ): Promise<{ data: DeliveryHistoryAsClient[]; totalRows: number }> {
    try {
      const response = await axiosInstance.get<{
        data: DeliveryHistoryAsClient[];
        totalRows: number;
      }>("/client/shipments/delivery/myHistoryAsClient", {
        params: {
          page: pageIndex,
          limit: pageSize,
        },
  ...
  static async addReviewsAsClient(
    delivery_id: string,
    rate: number,
    comment: string
    ...
    try {
      const response = await axiosInstance.post(
        `/client/shipments/delivery/${delivery_id}/comments`,
        { rate, comment }
      );
      return response.data;
    } catch (error) {
  ...
  static async getDeliveryDetails(
    delivery_id: string
  ): Promise<DeliveryDetailsPage> {
    try {
      const response = await axiosInstance.get<DeliveryDetailsPage>(
        `/client/shipments/delivery/${delivery_id}`
      );
      return response.data;
    } catch (error) {
  ...
  static async cancelDelivery(delivery_id: string): Promise<any> {
    try {
      const response = await axiosInstance.delete(
        `/client/shipments/delivery/${delivery_id}/cancel`
      );
      return response.data;
    } catch (error) {
