  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        {
          title: t("client.components.footer.mentions_legales"),
          href: "/legal-notice",
        },
        {
          title: t("client.components.footer.notre_equipe"),
          href: "/our-teams",
        },
        { title: t("client.components.footer.securite"), href: "/security" },
        {
          title: t("client.components.footer.accessibilite"),
          href: "/accessibility",
        },
      ],
    },
    {
      ...
      links: [
        {
          title: t("client.components.footer.devenir_livreur"),
          href: "/become-deliveryman",
        },
        {
          title: t("client.components.footer.trouver_des_livraisons"),
          href: "/deliveries",
        },
        {
          title: t("client.components.footer.solution_ecologique"),
          href: "/ecology",
        },
      ],
    },
    {
      ...
      links: [
        {
          title: t("client.components.footer.devenir_prestataire"),
          href: "/become-provider",
        },
        {
          title: t("client.components.footer.les_decouvrir"),
          href: "/services",
        },
      ],
    },
    {
      ...
      links: [
        {
          title: t("client.components.footer.email"),
          href: "mailto:contact.ecodeli@gmail.com",
        },
        {
          title: t("client.components.footer.telephone"),
          href: "tel:+331234567890",
        },
        {
          title: t("client.components.footer.adresse"),
          href: "https://maps.google.com/?q=242+Rue+du+Faubourg+Saint-Antoine,+75012+Paris",
        },
      ],
    },
  ];
