...
const Navbar = ({
      ...
      items: [
        {
          ...
          description:
            "client.components.navbar.livraison.trouverLivraisonDescription",
          url: "/deliveries",
        },
        {
          titleKey: "client.components.navbar.livraison.devenirLivreur",
          description:
            "client.components.navbar.livraison.devenirLivreurDescription",
      ...
      items: [
        {
          ...
          description:
            "client.components.navbar.prestation.trouverPrestationsDescription",
          url: "/services",
        },
        {
          titleKey: "client.components.navbar.prestation.devenirPrestataire",
          description:
            "client.components.navbar.prestation.devenirPrestataireDescription",
          url: "/become-provider",
        },
      ],
    },
  ...
  auth = {
    register: {
      textKey: "client.components.navbar.register",
      url: "/auth/register",
    },
            ...
            <div className="flex items-center">
              <NavigationMenu>
                <NavigationMenuList>
                  {menu.map((item, index) =>
                    index === 0
                      ? renderMenuItemWithImage(item, t)
                      : renderMenuItem(item, t)
                  )}
                </NavigationMenuList>
              </NavigationMenu>
            </div>
            ...
            {user?.user_id ? (
              <Button asChild size="sm">
                <Link to="/office/dashboard">
                  {t("client.components.navbar.goToDashboard") ||
                      ...
                      <>
                        <Button asChild className="w-full" variant="link">
                          <Link to={auth.register.url}>
                            {t(auth.register.textKey)}
                          </Link>
                        </Button>
                        <Button asChild className="w-full">
                          <Link to={auth.login.url}>
                            {t(auth.login.textKey)}
                          </Link>
                        </Button>
                      </>
                    )}
